    ...
    fn ui(self, ui: &mut egui::Ui) -> egui::Response {
        ...
        ui.vertical(|ui| {
            ...
            if let Some(mine) = &self.prototype.burn {
                ui.label(t!("metatorio.fuel-value", mine.fuel_value.to_string()));
                ui.label(t!(
...
impl<'a> egui::Widget for PrototypeHover<'a, ModulePrototype> {
    fn ui(self, ui: &mut egui::Ui) -> egui::Response {
        ...
        ui.vertical(|ui| {
            ...
            ui.label(format!(
                "{}: {}",
                t!("metatorio.module-category"),
                self.prototype.category
            ));
            ui.label(format!(
                "{}: {}%",
                t!("metatorio.consumption"),
                effect.consumption * 100.0
            ));
            ui.label(format!(
                "{}: {}%",
                t!("metatorio.speed"),
            ...
            ui.label(format!(
                "{}: {}%",
                t!("metatorio.productivity"),
                effect.productivity * 100.0
            ));
            ui.label(format!(
                "{}: {}%",
                t!("metatorio.pollution"),
                effect.pollution * 100.0
            ));
            ui.label(format!(
                "{}: {}%",
                t!("metatorio.quality"),
